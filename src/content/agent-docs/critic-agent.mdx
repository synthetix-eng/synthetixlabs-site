...
Critic is the independent quality and policy challenge surface. In Synthetix<span class="tm">™</span> it is implemented as a critic family that evaluates analyst, architecture, and ARL outputs against deterministic rules and governance expectations.
