...
Scout is the deep-discovery and reconnaissance documentation surface. In Synthetix<span class="tm">™</span> this function is provided by the Discover agent trio, supported by Analyst context to connect discovery signals to business capability intent.
