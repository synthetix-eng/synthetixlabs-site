...
Cartographer is the discovery and system-mapping documentation surface. In Synthetix<span class="tm">™</span> this capability is delivered by Analyst plus the Discover agent trio, which together produce structural visibility of routes, data, background execution, and capability intent.
