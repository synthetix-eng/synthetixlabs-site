...
//#region src/pages/resources/blogs/[slug].astro
...
async function getStaticPaths() {
	return (await getCollection("articles", ({ data }) => !data.draft)).map((entry) => ({
...
var $$Slug = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Post", $$Post, {
		...
		"canonical": `https://synthetixlabs.ai/resources/blogs/${entry.id}/`,
		...
		"author": "Nitin Sinha",
		"authorSlug": entry.data.author
	}, { "default": ($$result) => renderTemplate`${renderComponent($$result, "Content", Content, {})}` })}`;
}, "/Users/vishak/Projects/Synthetix Labs Website/synthetixlabs-site/src/pages/resources/blogs/[slug].astro", void 0);
var $$file = "/Users/vishak/Projects/Synthetix Labs Website/synthetixlabs-site/src/pages/resources/blogs/[slug].astro";
var $$url = "/resources/blogs/[slug]";
//#endregion
//#region \0virtual:astro:page:src/pages/resources/blogs/[slug]@_@astro
