import { D as LocalImageUsedWrongly, E as InvalidImageService, K as RemoteImageNotAllowed, L as NoImageMetadata, N as MissingImageDimension, S as IncompatibleDescriptorOptions, d as ExpectedImageOptions, f as ExpectedNotESMImage, nt as UnsupportedImageConversion, p as FailedToFetchRemoteImageDimensions, rt as UnsupportedImageFormat, t as AstroError, u as ExpectedImage } from "./errors_Bwa88lUp.mjs";
import { l as isRemotePath, m as removeQueryString, u as joinPaths } from "./path_ca21oV8k.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_EhzPuG76.mjs").catch((e) => {
...
//#endregion
export { inferRemoteSize as a, inferSourceFormat as c, isRemoteImage as d, resolveSrc as f, parseQuality as i, resolveDefaultOutputFormat as l, getImage as n, fetchWithRedirects as o, baseService as r, detector as s, getConfiguredImageService as t, isESMImportedImage as u };
