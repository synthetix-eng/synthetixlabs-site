...
async function getStaticPaths() {
	return (await getCollection("agent-docs", ({ data }) => !data.draft)).map((entry) => ({
...
var $$Slug = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Post", $$Post, {
		...
		"canonical": `https://synthetixlabs.ai/resources/blogs/resources/product-documentation/${entry.id}/`,
...
}, "/Users/vishak/Projects/Synthetix Labs Website/synthetixlabs-site/src/pages/resources/blogs/resources/product-documentation/[slug].astro", void 0);
var $$file = "/Users/vishak/Projects/Synthetix Labs Website/synthetixlabs-site/src/pages/resources/blogs/resources/product-documentation/[slug].astro";
var $$url = "/resources/blogs/resources/product-documentation/[slug]";
//#endregion
//#region \0virtual:astro:page:src/pages/resources/blogs/resources/product-documentation/[slug]@_@astro
